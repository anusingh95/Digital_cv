...
''', unsafe_allow_html=True)
    st.markdown("""<font color=red>*If you want to learn more about me,my family background,my eduction,my poject and job related queries, just hop over to the "Ask Anything" tab. My AI assistant will provide you all the details about me and my career projects.*</font>""", unsafe_allow_html=True)
    st.write("---")
